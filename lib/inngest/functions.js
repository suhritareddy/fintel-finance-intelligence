...
async function generateFinancialInsights(stats, month) {
  ...
  try {
    ...
    return [
      "Your highest expense category may need optimization.",
      "Consider setting a fixed savings goal each month.",
      "Tracking recurring expenses can help reduce unnecessary spending.",
    ];
  }
}
