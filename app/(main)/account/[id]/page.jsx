  ...
  return (
    <div className="px-5 max-w-7xl mx-auto space-y-6">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-0 hover:opacity-100 transition-opacity duration-300 bg-linear-to-br from-emerald-200/20 to-transparent dark:from-slate-700/30 pointer-events-none" />
      </Card>
      ...
      {/* TRANSACTION TABLE */}
      <Suspense fallback={<BarLoader color="#10B981" className="mt-4 w-full" />}>
        <div className="rounded-2xl bg-emerald-50/80 dark:bg-slate-800/60 backdrop-blur-xl border border-emerald-200/40 dark:border-slate-700/50 shadow-md p-6 md:p-9">
